...
public class CommonUtils {
    ...
    public static final String CREDENTIALS_FILE = "C:\\Users\\new\\IdeaProjects\\packagexmlgenerator\\src\\main\\resources\\credentials.json";
    ...
    public static String getUsername(final JSONObject jsonObj) throws JSONException {
    ...
    public static String getPassword(final JSONObject jsonObj) throws JSONException {
        final JSONObject credential = jsonObj.getJSONObject(CREDENTIALS);
    ...
    public static String getOrgType(final JSONObject jsonObj) throws JSONException {
        final JSONObject credential = jsonObj.getJSONObject(CREDENTIALS);
    ...
    public static Double getApiVersion(final JSONObject jsonObj) throws JSONException {
        final JSONObject credential = jsonObj.getJSONObject(CREDENTIALS);
